...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"10px 0 20px","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto","order":"2"}'>
	  ...
	  <el-button v-if="isAuth('kechengxinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#00b9ea","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/kechengxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"950px","margin":"0 0 10px","flex":"1","order":"4"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 10px","flex":"1","height":"auto"}'>
			<div :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","padding":"10px","margin":"10px 1%","textAlign":"center","background":"#fff","display":"inline-block","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","lineHeight":"30px","fontSize":"14px","color":"rgba(0, 0, 0, 1)"}' class="name ">{{item.kechengmingcheng}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"30px","fontSize":"14px","color":"rgba(0, 0, 0, 1)"}' class="name ">{{item.kechengfenlei}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"30px","fontSize":"14px","color":"rgba(0, 0, 0, 1)"}' class="name ">{{item.jiaoshixingming}}</div>
			</div>
		</div>
...
<script>
  export default {
    ...
    created() {
      ...
      this.$http.get('option/kechengfenlei/kechengfenlei').then(res => {
        if (res.data.code == 0) {
