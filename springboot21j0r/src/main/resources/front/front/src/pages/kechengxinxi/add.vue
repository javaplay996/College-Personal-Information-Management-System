...
<div :style='{"width":"1100px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="课程资料" prop="kechengziliao">
            <file-upload
            tip="点击上传课程资料"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="教学视频" prop="jiaoxueshipin">
            <file-upload
            tip="点击上传教学视频"
            action="file/upload"
            :limit="1"
  ...
  export default {
    ...
    // 多级联动参数
      ...
      kechengziliaoUploadChange(fileUrls) {
          this.ruleForm.kechengziliao = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
