    ...
    <el-tabs tab-position="left" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","background":"rgba(218, 242, 255, 1)"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="账号" prop="zhanghao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="学生姓名" prop="xueshengxingming">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="班级">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="教师账号" prop="jiaoshizhanghao">
            <el-input v-model="sessionForm.jiaoshizhanghao" placeholder="教师账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="教师姓名" prop="jiaoshixingming">
            <el-input v-model="sessionForm.jiaoshixingming" placeholder="教师姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="照片">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              ...
              <img :style='{"border":"1px dashed #00B9EA","cursor":"pointer","color":"rgba(64, 158, 255, 1)","borderRadius":"6px","textAlign":"center","background":"rgba(246, 246, 246, 1)","width":"80px","fontSize":"32px","lineHeight":"80px","height":"80px"}' v-if="sessionForm.zhaopian" :src="baseUrl + sessionForm.zhaopian" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="资历" prop="zili">
            <el-input v-model="sessionForm.zili" placeholder="资历" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="联系方式" prop="lianxifangshi">
            <el-input v-model="sessionForm.lianxifangshi" placeholder="联系方式" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="邮箱" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="邮箱" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='jiaoshi'" label="资格证书">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="jiaoshizigezhengshuHandleAvatarSuccess">
              <img :style='{"border":"1px dashed #00B9EA","cursor":"pointer","color":"rgba(64, 158, 255, 1)","borderRadius":"6px","textAlign":"center","background":"rgba(246, 246, 246, 1)","width":"80px","fontSize":"32px","lineHeight":"80px","height":"80px"}' v-if="sessionForm.zigezhengshu" :src="baseUrl + sessionForm.zigezhengshu" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('jiaoshi' == this.userTableName) {
        this.$set(this.sessionForm, 'zili', null);
      }
      if ('jiaoshi' == this.userTableName) {
      ...
      if ('jiaoshi' == this.userTableName) {
        this.$set(this.sessionForm, 'zigezhengshu', null);
      }
    ...
    methods: {
      ...
      jiaoshizigezhengshuHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('jiaoshi' == this.userTableName) {
            this.sessionForm.zigezhengshu = 'upload/' + res.file;
          }
        }
      },
      chongzhi() {
