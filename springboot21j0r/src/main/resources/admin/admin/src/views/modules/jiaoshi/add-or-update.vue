	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.zigezhengshu" label="资格证书" prop="zigezhengshu">
					<file-upload
						tip="点击上传资格证书"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.zigezhengshu" label="资格证书" prop="zigezhengshu">
					<img v-if="ruleForm.zigezhengshu.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.zigezhengshu.split(',')[0]" width="100" height="100">
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zigezhengshu.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
			</template>
