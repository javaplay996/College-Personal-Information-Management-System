	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="完成日期" prop="wanchengriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.wanchengriqi" label="完成日期" prop="wanchengriqi">
					<el-input v-model="ruleForm.wanchengriqi" placeholder="完成日期" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="作业内容" prop="zuoyeneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.zuoyeneirong" label="作业内容" prop="zuoyeneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zuoyeneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zuoyeneirong = this.ruleForm.zuoyeneirong.replace(reg,'../../../springboot21j0r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
