	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="作业布置" prop="zuoyebuzhi">
					<el-input v-model="ruleForm.zuoyebuzhi" placeholder="作业布置" clearable  :readonly="ro.zuoyebuzhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="作业布置" prop="zuoyebuzhi">
					<el-input v-model="ruleForm.zuoyebuzhi" placeholder="作业布置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="主要内容" prop="zhuyaoneirong">
					<el-input v-model="ruleForm.zhuyaoneirong" placeholder="主要内容" clearable  :readonly="ro.zhuyaoneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="主要内容" prop="zhuyaoneirong">
					<el-input v-model="ruleForm.zhuyaoneirong" placeholder="主要内容" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="完成状态" prop="wanchengzhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="完成状态" prop="wanchengzhuangtai">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.wanchengzhuangtaiOptions = "已完成,未完成".split(',')
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zuoyetongzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zuoyetongzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
